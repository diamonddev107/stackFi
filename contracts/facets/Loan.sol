...
<<<<<<< HEAD
    ...
    function getFairPriceLoan(uint256 _requestId)
        external
        view
        override
    ...
    modifier authLoan() {
        ...
        require(
            LibOpen._hasAdminRole(ds.superAdmin, ds.superAdminAddress) ||
                LibOpen._hasAdminRole(ds.adminLoan, ds.adminLoanAddress),
            "ERROR: Not an admin"
        );
        _;
    }
