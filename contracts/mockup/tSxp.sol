...
contract tSxp is Context, IBEP20 {
    ...
    function transferFrom(
        ...
        _approve(
            ...
            _allowances[sender][_msgSender()].sub(
                amount,
                "SXP: transfer amount exceeds allowance"
            )
        );
        return true;
    }
        ...
        returns (bool)
    {
        _approve(
            ...
            _allowances[_msgSender()][spender].sub(
                subtractedValue,
                "SXP: decreased allowance below zero"
            )
        );
        return true;
    }
    ...
    function _transfer(
        ...
        _balances[sender] = _balances[sender].sub(
            amount,
            "SXP: transfer amount exceeds balance"
        );
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        _balances[account] = _balances[account].sub(
            amount,
            "SXP: burn amount exceeds balance"
        );
    ...
    function _burnFrom(address account, uint256 amount) internal {
        ...
        _approve(
            ...
            _allowances[account][_msgSender()].sub(
                amount,
                "SXP: burn amount exceeds allowance"
            )
        );
    }
}
