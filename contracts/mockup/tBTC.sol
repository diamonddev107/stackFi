...
contract tBTC is Context, IBEP20 {
        ...
        returns (bool)
    {
        _approve(
            ...
            _allowances[_msgSender()][spender].sub(
                subtractedValue,
                "Bitcoin: decreased allowance below zero"
            )
        );
        return true;
    }
    ...
    function _transfer(
        ...
        require(
            sender != address(0),
            "Bitcoin: transfer from the zero address"
        );
        require(
            recipient != address(0),
            "Bitcoin: transfer to the zero address"
        );

        _balances[sender] = _balances[sender].sub(
            amount,
            "Bitcoin: transfer amount exceeds balance"
        );
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        _balances[account] = _balances[account].sub(
            amount,
            "Bitcoin: burn amount exceeds balance"
        );
    ...
    function _burnFrom(address account, uint256 amount) internal {
        ...
        _approve(
            ...
            _allowances[account][_msgSender()].sub(
                amount,
                "Bitcoin: burn amount exceeds allowance"
            )
        );
    }
}
