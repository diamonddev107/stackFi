...
contract tUSDC is Context, IBEP20 {
    ...
    function transferFrom(
        ...
        _approve(
            ...
            _allowances[sender][_msgSender()].sub(
                amount,
                "USD-Coin: transfer amount exceeds allowance"
            )
        );
        return true;
    }
        ...
        returns (bool)
    {
        _approve(
            ...
            _allowances[_msgSender()][spender].sub(
                subtractedValue,
                "USD-Coin: decreased allowance below zero"
            )
        );
        return true;
    }
    ...
    function _transfer(
        ...
        require(
            sender != address(0),
            "USD-Coin: transfer from the zero address"
        );
        require(
            recipient != address(0),
            "USD-Coin: transfer to the zero address"
        );

        _balances[sender] = _balances[sender].sub(
            amount,
            "USD-Coin: transfer amount exceeds balance"
        );
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        _balances[account] = _balances[account].sub(
            amount,
            "USD-Coin: burn amount exceeds balance"
        );
    ...
    function _burnFrom(address account, uint256 amount) internal {
        ...
        _approve(
            ...
            _allowances[account][_msgSender()].sub(
                amount,
                "USD-Coin: burn amount exceeds allowance"
            )
        );
    }
}
