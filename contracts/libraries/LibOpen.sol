...
<<<<<<< HEAD
    ...
    address internal constant PANCAKESWAP_ROUTER_ADDRESS =
        0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // pancakeswap bsc testnet router address
...
<<<<<<< HEAD
    ...
    function _getFairPriceAddress(bytes32 _market)
        internal
        view
        returns (address)
    {
...
<<<<<<< HEAD
    function diamondStorage()
        internal
        pure
        returns (AppStorageOpen storage ds)
    {
        assembly {
            ds.slot := 0
        }
    ...
    function _removeMarketSupport(bytes32 _market)
        internal
        authContract(TOKENLIST_ID)
    {
        AppStorageOpen storage ds = diamondStorage();
    ...
    function _getMarketAddress(bytes32 _market)
        internal
        view
        returns (address)
    {
    ...
    function _getMarketDecimal(bytes32 _market)
        internal
        view
        returns (uint256)
    {
...
<<<<<<< HEAD
    function _isMarket2Supported(bytes32 _market) internal view {
        require(
            ...
            "Secondary Token is not supported"
        );
    }

    function _getMarket2Address(bytes32 _market)
        internal
        view
        returns (address)
    {
    ...
    function _removeMarket2Support(bytes32 _market)
        internal
        authContract(TOKENLIST_ID)
    {
        AppStorageOpen storage ds = diamondStorage();
    ...
    function _getMarket2Decimal(bytes32 _market)
        internal
        view
        returns (uint256)
    {
    ...
    function _connectMarket(bytes32 _market)
        private
        view
...
<<<<<<< HEAD
    ...
    function _updateApy(bytes32 _commitment, uint256 _apy)
        internal
        authContract(COMPTROLLER_ID)
        returns (bool)
    {
        AppStorageOpen storage ds = diamondStorage();
    ...
    function _setCommitment(bytes32 _commitment)
        internal
        authContract(COMPTROLLER_ID)
    {
        AppStorageOpen storage ds = diamondStorage();
    ...
    function _updateApr(bytes32 _commitment, uint256 _apr)
        internal
        authContract(COMPTROLLER_ID)
        returns (bool)
    {
        ...
        )
    {
        ...
        if (apr.time.length > oldLengthAccruedInterest) {
            if (apr.time[index] < time) {
                ...
                aggregateInterest =
                    ((((apr.time[newIndex] - time) * apr.aprChanges[index]) /
                        10000) * 365) /
                    (100 * 1000);
                ...
                for (uint256 i = newIndex; i < apr.aprChanges.length; i++) {
                    ...
                    aggregateInterest +=
                        (((timeDiff * apr.aprChanges[newIndex]) / 10000) *
                            365) /
                        (100 * 1000);
                }
                ...
                for (uint256 i = index; i < apr.aprChanges.length; i++) {
                    uint256 timeDiff = apr.time[i + 1] - apr.time[i];
                    aggregateInterest +=
                        (((timeDiff * apr.aprChanges[index]) / 10000) * 365) /
                        (100 * 1000);
                }
            }
        } else if (
            apr.time.length == oldLengthAccruedInterest &&
            block.timestamp > oldLengthAccruedInterest
        ) {
            if (apr.time[index] < time || apr.time[index] == time) {
                aggregateInterest +=
                    ((block.timestamp - time) * apr.aprChanges[index]) /
                    10000;
                // Convert the aprChanges to the lowest unit value.
        ...
        )
    {
        ...
        if (apy.time.length > oldLengthAccruedYield) {
            if (apy.time[index] < time) {
                ...
                // Convert the aprChanges to the lowest unit value.
                aggregateYield =
                    ((((apy.time[newIndex] - time) * apy.apyChanges[index]) /
                        10000) * 365) /
                    (100 * 1000);
                ...
                for (uint256 i = newIndex; i < apy.apyChanges.length; i++) {
                    ...
                    aggregateYield +=
                        (((timeDiff * apy.apyChanges[newIndex]) / 10000) *
                            365) /
                        (100 * 1000);
                }
                ...
                for (uint256 i = index; i < apy.apyChanges.length; i++) {
                    uint256 timeDiff = apy.time[i + 1] - apy.time[i];
                    aggregateYield +=
                        (((timeDiff * apy.apyChanges[index]) / 10000) * 365) /
                        (100 * 1000);
                }
            }
        } else if (
            apy.time.length == oldLengthAccruedYield &&
            block.timestamp > oldLengthAccruedYield
        ) {
            if (apy.time[index] < time || apy.time[index] == time) {
                aggregateYield +=
                    ((block.timestamp - time) * apy.apyChanges[index]) /
                    10000;
                // Convert the aprChanges to the lowest unit value.
                // aggregateYield = (((apr.time[newIndex] - time) *apr.aprChanges[index])/10000)*365/(100*1000);
            }
...
<<<<<<< HEAD
        ...
        IBEP20(addrFromMarket).transferFrom(
            msg.sender,
            address(this),
            _fromAmount
        );
...
<<<<<<< HEAD
    ...
    function _avblReservesDeposit(bytes32 _market)
        internal
        view
        returns (uint256)
    {
    ...
    function _utilisedReservesDeposit(bytes32 _market)
        internal
        view
        returns (uint256)
    {
    ...
    function _avblReservesLoan(bytes32 _market)
        internal
        view
        returns (uint256)
    {
    ...
    function _utilisedReservesLoan(bytes32 _market)
        internal
        view
        returns (uint256)
    {
    ...
    function _withdrawDeposit(
        ...
        uint256 _savingsBalance = _accountBalance(
            _account,
            _market,
            _commitment,
            _request
...
<<<<<<< HEAD
        ...
        DepositRecords storage deposit = ds.indDepositRecord[_account][_market][
            _commitment
        ];
        YieldLedger storage yield = ds.indYieldRecord[_account][_market][
            _commitment
        ];

        (yield.oldLengthAccruedYield, yield.oldTime, aggregateYield) = _calcAPY(
            _commitment,
    ...
    function _preDepositProcess(bytes32 _market, uint256 _amount)
        private
    ...
    function _processNewDeposit(
        // address _account,bytes32 _market,bytes32 _commitment,
        uint256 _amount,
    ...
    function _processDeposit(
        ...
        savingsAccount.yield[num].oldLengthAccruedYield = yield
    ...
    function _hasAccount(address _account) internal view {
        AppStorageOpen storage ds = diamondStorage();
        require(
            ds.savingsPassbook[_account].accOpenTime != 0,
    ...
    function _accountBalance(
        ...
        bytes32 _commitment,
        IDeposit.SAVINGSTYPE _request
    ) internal authContract(DEPOSIT_ID) returns (uint256) {
        AppStorageOpen storage ds = diamondStorage();

        uint256 _savingsBalance;
    ...
    function _updateSavingsBalance(
        address _account,
        bytes32 _market,
        bytes32 _commitment,
        uint256 _amount,
        ...
        if (_request == IDeposit.SAVINGSTYPE.DEPOSIT) {
            ...
            if (
                yield.isTimelockApplicable == false ||
                block.timestamp >= yield.activationTime + yield.timelockValidity
            ) {
                // _accruedYield(_account,_market,_commitment);
    ...
    function _createNewDeposit(
        ...
        DepositRecords storage deposit = ds.indDepositRecord[_sender][_market][
            _commitment
        ];
        YieldLedger storage yield = ds.indYieldRecord[_sender][_market][
            _commitment
        ];
    ...
    function _addToDeposit(
        ...
        emit DepositAdded(
            ...
            _commitment,
            _amount,
            ds.indDepositRecord[_sender][_market][_commitment].id
        );
    }

    function _ensureSavingsAccount(
        address _account,
        SavingsAccount storage savingsAccount
    ) private {
    ...
    function _swapToLoanProcess(
        ...
        LoanRecords storage loan = ds.indLoanRecords[_account][_market][
            _commitment
        ];
        ...
        CollateralYield storage cYield = ds.indAccruedAPY[_account][_market][
            _commitment
        ];

        require(loan.id != 0, "ERROR: No loan");
        require(
            loan.isSwapped == true && loanState.currentMarket == _swapMarket,
    ...
    function _withdrawCollateral(
        ...
        _isMarketSupported(_market);
        require(
            ds.marketReservesLoan[collateral.market] >= collateral.amount,
            "Not enough fund in reserve"
        );
...
<<<<<<< HEAD
        ...
        //if (_commitment != _getCommitment(0)) {
        require(
            (collateral.timelockValidity + collateral.activationTime) >=
                block.timestamp,
            "ERROR: Timelock in progress"
        );
        //}
...
<<<<<<< HEAD
    ...
    function _updateDebtRecords(
        LoanAccount storage loanAccount,
        LoanRecords storage loan,
        LoanState storage loanState,
        CollateralRecords storage collateral /*, DeductibleInterest storage deductibleInterest, CollateralYield storage cYield*/
    ) private {
        AppStorageOpen storage ds = diamondStorage();
        uint256 num = loan.id - 1;
        ...
        delete ds.indAccruedAPY[loanAccount.account][loan.market][
            loan.commitment
        ];
        delete ds.indAccruedAPR[loanAccount.account][loan.market][
            loan.commitment
        ];
...
<<<<<<< HEAD
        ...
        (oldLengthAccruedInterest, oldTime, aggregateYield) = _calcAPR(
            ...
            ds
            .indAccruedAPR[_account][_loanMarket][_commitment]
        ...
        deductibleUSDValue =
            ((ds.indLoanRecords[_account][_loanMarket][_commitment].amount) *
                _getLatestPrice(_loanMarket)) *
            aggregateYield;
        ds.indAccruedAPR[_account][_loanMarket][_commitment].accruedInterest +=
            deductibleUSDValue /
            _getLatestPrice(
                ds
                .indCollateralRecords[_account][_loanMarket][_commitment].market
            );
        ds
        .indAccruedAPR[_account][_loanMarket][_commitment]
        ...
        ds
            ...
            .accruedAPR[
                ds.indLoanRecords[_account][_loanMarket][_commitment].id - 1
            ]
            .accruedInterest = ds
        .indAccruedAPR[_account][_loanMarket][_commitment].accruedInterest;
        ds
            .loanPassbook[_account]
            .accruedAPR[
                ds.indLoanRecords[_account][_loanMarket][_commitment].id - 1
    ...
    function _checkPermissibleWithdrawal(
        ...
        uint256 _amount,
        address _sender /*authContract(LOAN_ID)*/
    ) private {
        AppStorageOpen storage ds = diamondStorage();
        // LoanRecords storage loan = ds.indLoanRecords[_sender][_market][_commitment];
        LoanState storage loanState = ds.indLoanState[_sender][_market][
            _commitment
        ];
        CollateralRecords storage collateral = ds.indCollateralRecords[_sender][
            _market
        ][_commitment];
        ...
        require(
            _amount <= loanState.currentAmount,
            "ERROR: Exceeds available loan"
        );

        _accruedInterest(_sender, _market, _commitment);
        uint256 collateralAvbl = collateral.amount -
            ds.indAccruedAPR[_sender][_market][_commitment].accruedInterest;
        ...
        uint256 permissibleAmount = ((usdCollateral *
            collateralAvbl -
            ((30 * usdCollateral * collateral.amount) / 100)) / usdLoanCurrent);
        ...
        require(
            (usdCollateral *
                ...
                usdLoanCurrent *
                loanState.currentAmount -
                (_amount * usdLoanCurrent)) >=
                ((11 *
                    (usdLoan *
                        ds
                        .indLoanRecords[_sender][_market][_commitment]
                            .amount)) / 10),
            "ERROR: Risks liquidation"
        );
    }
    ...
    function _repaymentProcess(
        ...
        uint256 collateralAmount = collateral.amount -
            (deductibleInterest.accruedInterest + cYield.accruedYield);
        _repayAmount += _swap(
            collateral.market,
            loan.market,
            collateralAmount,
        ...
        if (_commitment == _getCommitment(2)) {
            ...
            // delete loan;
            // delete collateral;
            delete ds.indCollateralRecords[_account][loan.market][
                loan.commitment
            ];
            delete ds.indLoanState[_account][loan.market][loan.commitment];
            delete ds.indLoanRecords[_account][loan.market][loan.commitment];
    ...
    function _processNewLoan(
        ...
        DeductibleInterest storage deductibleInterest = ds.indAccruedAPR[
            _account
        ][_market][_commitment];
        CollateralYield storage cYield = ds.indAccruedAPY[_account][_market][
            _commitment
        ...
        if (_commitment == _getCommitment(0)) {
            ...
            // pays 18% APR
            deductibleInterest.oldLengthAccruedInterest = _getAprTimeLength(
                _commitment
            );
    ...
    function _permissibleCDR(
        ...
        uint256 rF = _getReserveFactor() * _marketReserves(_market);
        ...
        require(
            _marketReserves(_market) >= rF + amount,
            "ERROR: Minimum reserve exeception"
        );
        ...
        if (
            ...
            amount + (3 * _marketReserves(_market)) / 4
        ) {
            loanByCollateral = 3;
        } else {
            loanByCollateral = 2;
        ...
        require(
            usdLoan / usdCollateral <= loanByCollateral,
            "ERROR: Exceeds permissible CDR"
        );
    }
    ...
    function _addCollateral(
        ...
        LoanRecords storage loan = ds.indLoanRecords[_sender][_market][
            _commitment
        ];
        LoanState storage loanState = ds.indLoanState[_sender][_market][
            _commitment
        ...
        CollateralYield storage cYield = ds.indAccruedAPY[_sender][_market][
            _commitment
        ];
        ...
        ds.collateralToken = IBEP20(_connectMarket(_collateralMarket));
        // _quantifyAmount(_collateralMarket, _collateralAmount);
        ds.collateralToken.approveFrom(
            _sender,
            address(this),
            _collateralAmount
        );
    ...
    function _swapLoan(
        ...
        require(loan.id != 0, "ERROR: No loan");
        require(
            loan.isSwapped == false && loanState.currentMarket == _market,
    ...
    function _loanRequest(
        ...
        AppStorageOpen storage ds = diamondStorage();
        console.log(
            "avblReserve is %s loanAmount is %s",
            _avblMarketReserves(_market),
            _loanAmount
        );
        require(
            _avblMarketReserves(_market) >= _loanAmount,
            "ERROR: Borrow amount exceeds reserves"
        );
        ...
        emit NewLoan(
            ...
            _collateralMarket,
            _collateralAmount,
            ds.loanPassbook[_sender].loans.length + 1
        );
    }
    ...
    function _repayLoan(
        ...
        require(
            diamondStorage().indLoanRecords[_sender][_market][_commitment].id !=
                0,
            "ERROR: No Loan"
        );
        _isMarketSupported(_market);
        ...
        _accruedYield(
            ...
            diamondStorage().indCollateralRecords[_sender][_market][
                _commitment
            ],
        ...
        if (_repayAmount == 0) {
            ...
            if (
                diamondStorage()
                .indLoanState[_sender][_market][_commitment].currentMarket ==
                _market
            )
                _repayAmount = diamondStorage()
                .indLoanState[_sender][_market][_commitment].currentAmount;
            else if (
                diamondStorage()
                .indLoanState[_sender][_market][_commitment].currentMarket !=
                _market
            ...
            diamondStorage()
            .indCollateralRecords[_sender][_market][_commitment]
                .amount += (diamondStorage()
            .indAccruedAPY[_sender][_market][_commitment].accruedYield -
                diamondStorage()
                .indAccruedAPR[_sender][_market][_commitment].accruedInterest);
            ...
            if (
                _repayAmount >=
                diamondStorage()
                .indLoanRecords[_sender][_market][_commitment].amount
            ) {
                _remnantAmount =
                    _repayAmount -
                    diamondStorage()
                ...
                if (
                    diamondStorage()
                    .indLoanState[_sender][_market][_commitment]
                        .currentMarket == _market
                ) {
                    _remnantAmount += diamondStorage()
                    .indLoanState[_sender][_market][_commitment].currentAmount;
                } else {
                    _swapToLoanProcess(
                        _sender,
                ...
                _updateDebtRecords(
                    diamondStorage().loanPassbook[_sender],
                    diamondStorage().indLoanRecords[_sender][_market][
                        _commitment
                    ],
                    diamondStorage().indLoanState[_sender][_market][
                        _commitment
                    ],
                    diamondStorage().indCollateralRecords[_sender][_market][
                        _commitment
                    ] /*, deductibleInterest, cYield*/
                );
                diamondStorage().loanToken.approveFrom(
                    diamondStorage().reserveAddress,
                    address(this),
                    _remnantAmount
                );
                diamondStorage().loanToken.transferFrom(
                    diamondStorage().reserveAddress,
                    diamondStorage().loanPassbook[_sender].account,
                    _remnantAmount
                );
                ...
                emit LoanRepaid(
                    _sender,
                    diamondStorage()
                    .indLoanRecords[_sender][_market][_commitment].id,
                    diamondStorage()
                    .indLoanRecords[_sender][_market][_commitment].market,
                    block.timestamp
                );
                ...
                if (_commitment == _getCommitment(0)) {
                    ...
                    delete diamondStorage().indLoanRecords[_sender][_market][
                        _commitment
                    ];
                    delete diamondStorage().indLoanState[_sender][_market][
                        _commitment
                    ];
                    delete diamondStorage().indCollateralRecords[_sender][
                        _market
                    ][_commitment];

                    delete diamondStorage().loanPassbook[_sender].loanState[
                        diamondStorage()
                        .indLoanRecords[_sender][_market][_commitment].id - 1
                    ];
                    delete diamondStorage().loanPassbook[_sender].loans[
                        diamondStorage()
                        .indLoanRecords[_sender][_market][_commitment].id - 1
                    ];
                    delete diamondStorage().loanPassbook[_sender].collaterals[
                        diamondStorage()
                        .indLoanRecords[_sender][_market][_commitment].id - 1
                    ];
    ...
    function _hasLoanAccount(address _account) internal view returns (bool) {
        AppStorageOpen storage ds = diamondStorage();
        require(
            ds.loanPassbook[_account].accOpenTime != 0,
            "ERROR: No Loan Account"
        );
        return true;
    }

    function _permissibleWithdrawal(
        bytes32 _market,
        bytes32 _commitment,
        bytes32 _collateralMarket,
        uint256 _amount,
        address _sender
    ) internal authContract(LOAN1_ID) returns (bool success) {
        AppStorageOpen storage ds = diamondStorage();
        _hasLoanAccount(_sender);
    ...
    function _liquidation(address _account, uint256 _id)
        internal
        authContract(LOAN1_ID)
    {
        AppStorageOpen storage ds = diamondStorage();
        bytes32 _commitment = ds
            .loanPassbook[_account]
            .loans[_id - 1]
            .commitment;
        ...
        if (loan.commitment == _getCommitment(2))
            collateral.amount +=
                ds.indAccruedAPY[_account][_market][_commitment].accruedYield -
        ...
        uint256 cAmount = _getLatestPrice(collateral.market) *
            collateral.amount;
        uint256 lAmountCurrent = _getLatestPrice(loanState.currentMarket) *
            loanState.currentAmount;
        // convert collateral & loanCurrent into loanActual
        uint256 _repaymentAmount = _swap(
            collateral.market,
            loan.market,
            cAmount,
            2
        );
        _repaymentAmount += _swap(
            loanState.currentMarket,
            loan.market,
            lAmountCurrent,
            1
    ...
    function _collateralTransfer(
        ...
        bytes32 _market,
        bytes32 _commitment
    ) internal authContract(RESERVE_ID) {
        AppStorageOpen storage ds = diamondStorage();
        bytes32 collateralMarket;
        uint256 collateralAmount;
    ...
    function _avblMarketReserves(bytes32 _market)
        internal
        view
        returns (uint256)
    {
        require(
            (_marketReserves(_market) - _marketUtilisation(_market)) >= 0,
            "Mathematical error"
        );
...
<<<<<<< HEAD
    ...
    function _addRole(bytes32 role, address account)
        internal
        authContract(ACCESSREGISTRY_ID)
    {
        AppStorageOpen storage ds = diamondStorage();
    ...
    function _addAdminRole(bytes32 role, address account)
        internal
        authContract(ACCESSREGISTRY_ID)
    {
        AppStorageOpen storage ds = diamondStorage();
    ...
    function _revokeAdmin(bytes32 role, address account)
        internal
        authContract(ACCESSREGISTRY_ID)
    {
        AppStorageOpen storage ds = diamondStorage();
    ...
    modifier authContract(uint256 _facetId) {
        require(
            _facetId == diamondStorage().facetIndex[msg.sig] ||
                diamondStorage().facetIndex[msg.sig] == 0,
            "Not permitted function call"
        );
        _;
    }
=======
