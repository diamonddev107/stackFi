...
<<<<<<< HEAD
    ...
    await expect(
      deposit
        .connect(accounts[1])
        .addToDeposit(symbolUsdc, comit_NONE, depositAmount, {
          gasLimit: 5000000,
        })
    ).emit(library, "NewDeposit");
    ...
    await expect(
      deposit
        .connect(accounts[1])
        .addToDeposit(symbolBtc, comit_NONE, depositAmount, {
          gasLimit: 5000000,
        })
    ).emit(library, "NewDeposit");
...
>>>>>>> dinh-diamond2
  ...
  it("Check withdraw", async () => {
    await deposit
      .connect(accounts[1])
      .withdrawDeposit(symbolUsdt, comit_NONE, 0x100, 0);
  ...
  it("Check loan", async () => {
    await expect(
      loan1
        .connect(accounts[1])
        .loanRequest(symbolUsdt, comit_ONEMONTH, 0x200, symbolUsdt, 0x100, {
          gasLimit: 5000000,
        })
...
>>>>>>> dinh-diamond2
    ...
    await expect(
      loan1
        .connect(accounts[1])
        .loanRequest(symbolBtc, comit_ONEMONTH, 0x200, symbolBtc, 0x100, {
          gasLimit: 5000000,
        })
    ).to.emit(library, "NewLoan");
